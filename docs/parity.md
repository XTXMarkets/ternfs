...
TernFS supports erasure coding with up to 10 data blocks and 6 parity blocks.
At least one data block is required, and configurations with multiple data blocks
require at least one parity block.
